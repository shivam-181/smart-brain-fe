...
class Home extends Component {
  ...
  fetch("https://smart-brain-bn4z.onrender.com/clarifai", {
    method: "POST",
    ...
    .then((data) => {
      if (data) {
        ...
        if (this.props.user?.id) {
          fetch("https://smart-brain-bn4z.onrender.com/image", {
            method: "PUT",
            headers: { "Content-Type": "application/json" },
...
class App extends Component {
  ...
  async componentDidMount() {
    ...
    if (storedUser) {
      ...
      const response = await fetch("https://smart-brain-bn4z.onrender.com");
